...
TextRenderer::TextRenderer(unsigned int width, unsigned int height){
    ...
    this->textShader.setMatrix4("uProjection", glm::ortho(0.0f, static_cast<float>(width), static_cast<float>(height), 0.0f), true);
    this->textShader.setInteger("usText", 0);
...
void TextRenderer::renderText(std::string text, float x, float y, float scale, glm::vec3 color){
    ...
    this->textShader.use();
    this->textShader.setVector3f("uTextColor", color);
